...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $jumlah = $_POST['jumlah'];
    $note = $_POST['note'];
    $stmt = mysqli_prepare($conn, "INSERT INTO simpanan (user_id, tanggal, jumlah, note) VALUES (?,?,?,?)");
    mysqli_stmt_bind_param($stmt, "isds", $uid, $tanggal, $jumlah, $note);
...
<head>
<meta charset="utf-8">
<title>Simpanan - Koperasi Satria Manunggal</title>
...
<div class="main-content">
  ...
  <form method="post" class="card p-3 mb-4 shadow-sm">
    <div class="row g-2">
      ...
      <div class="col-md-4"><input type="text" name="note" class="form-control" placeholder="Catatan"></div>
      <div class="col-md-2"><button class="btn btn-primary w-100">Simpan</button></div>
    </div>
  </form>

  <table class="table table-bordered bg-white">
    <thead><tr><th>No</th><th>Tanggal</th><th>Jumlah</th><th>Catatan</th></tr></thead>
    <tbody>
