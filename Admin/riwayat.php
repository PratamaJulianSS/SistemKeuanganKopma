...
.badge-log{padding:6px 10px;border-radius:8px;font-size:12px;}
.badge-add{background:#198754;color:#fff;}
.badge-update{background:#0dcaf0;color:#fff;}
.badge-delete{background:#dc3545;color:#fff;}
.badge-approve{background:#0d6efd;color:#fff;}
</style>
</head>
<body>
  ...
  <div class="card p-3">
    ...
    <table class="table table-bordered bg-white align-middle mb-0">
      ...
      <tbody>
        ...
        <tr><td colspan="5" class="text-center text-muted">Tidak ada data riwayat sesuai filter.</td></tr>
        <?php endif; ?>
      </tbody>
    </table>
  </div>
